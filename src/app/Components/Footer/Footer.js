...
const Footer = () => {
  return (
    <>
      <Box sx={{height:{xs:'450px',sm:'400px',md:'350px'},width:'100%',background:'#EFA6CC',marginTop:{xs:'20px',sm:'30px',md:'50px'},display:{xs:'flex',sm:'flex',md:'flex'},alignItems:'center',flexDirection:'column',justifyContent:'center',gap:'30px'}}>
