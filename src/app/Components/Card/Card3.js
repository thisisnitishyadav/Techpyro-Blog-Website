  ...
  return (
    <>
     ...
     <Box sx={{display:{xs:'flex',sm:'flex',md:'flex'},justifyContent:'space-between',alignItems:'center',margin:{xs:'50px 0px 20px 0px',sm:'50px 0px 20px 0px',md:'100px 200px 0px 200px'}}}>
        <Typography sx={{color:'rgba(0,0,0,0.7)',fontSize:{xs:'25px',sm:'30px',md:'40px'},fontFamily:'fantasy'}}>APPS</Typography>
        <Typography sx={{display:'flex',alignItems:'center'}}>READ ALL APPS<KeyboardArrowRight /></Typography>
    </Box>
...
<Typography sx={{fontWeight:'400'}}>Apps Topics:</Typography>
{/* <p>|</p> */}
