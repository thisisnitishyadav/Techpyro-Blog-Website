  ...
  return (
    <>
     ...
     <Box sx={{display:{xs:'flex',sm:'flex',md:'flex'},justifyContent:'space-between',alignItems:'center',margin:{xs:'50px 0px 20px 0px',sm:'50px 0px 20px 0px',md:'100px 200px 0px 200px'}}}>
        <Typography sx={{color:'rgba(0,0,0,0.7)',fontSize:{xs:'25px',sm:'30px',md:'40px'},fontFamily:'fantasy'}}>REVIEWS</Typography>
        <Typography sx={{display:'flex',alignItems:'center'}}>READ ALL REVIEWS<KeyboardArrowRight /></Typography>
    </Box>
...
<Typography sx={{fontWeight:'400'}}>Makeup Topics:</Typography>
{/* <p>|</p> */}
<Typography sx={{color:'#FC2779',fontSize:'14px',fontWeight:'600'}}>NAILS</Typography>
<Typography sx={{color:'#FC2779',fontSize:'14px',fontWeight:'600'}}>BRIDAL MAKEUP</Typography>
<Typography sx={{color:'#FC2779',fontSize:'14px',fontWeight:'600'}}>MAKEUP LOOKS</Typography>
<Typography sx={{color:'#FC2779',fontSize:'14px',fontWeight:'600'}}>FACE</Typography>
<Typography sx={{color:'#FC2779',fontSize:'14px',fontWeight:'600'}}>EYES</Typography>
<Typography sx={{color:'#FC2779',fontSize:'14px',fontWeight:'600'}}>LIPS</Typography>
    </Box>
...
<Box sx={{display:'flex',justifyContent:'center'}}>
      ...
      <CardMedia
        sx={{height:'100%'}}
          component="img"
          image={item&&item.sections.length!==0?item.sections[0].url.length!==0&&item.sections[0].url[0].path:"/images/blog12.jpeg"}
          alt="green iguana"
        />
